```00_LSTM_Setup.txt
first_layer_values = range(192, 257, 164)   # 48 to 256, step of 64
second_layer_values = [128]                 # [32, 128, 224]     # Second LSTM layer values - 32, 128, 224
dense_layer_values = [128]                  # [32, 128, 224]      # Dense layer values  - 32, 128, 224 = 16 x TOTAL 162 configurations
```
...
def create_model(first_layer, second_layer, dense_layer, learning_rate):
    ...
    # LSTM layers with L2 regularization and batch normalization
    model.add(LSTM(first_layer, input_shape=(sequence_length, X_train.shape[2]), return_sequences=True, kernel_regularizer=l2(0.001)))
    model.add(BatchNormalization())
    model.add(Dropout(0.2))
    
    model.add(LSTM(second_layer, kernel_regularizer=l2(0.001)))
    model.add(BatchNormalization())
    model.add(Dropout(0.2))
...
```xResults.txt
# LSTM Input: (192, 128, 128, 0.029)
| Series | Number 1 | Number 2 | Number 3 | Number 4 | Number 5 | Star 1 | Star 2 |
|---|---|---|---|---|---|---|---|
| Last Recorded | 7 | 10 | 31 | 41 | 46 | 1 | 5 |
| Prediction | 9 | 16 | 26 | 34 | 42 | 4 | 8 |
| Prediction Trend | Up | Up | Down | Down | Down | Up | Up |
| Actual Trend | Down | Down | Down | Down | Down | Up | Up |
| Actual Series | 2 | 3 | 17 | 40 | 44 | 4 | 8 |
First layer: 192
Second_layer: 128
Dense_layer: 128
Learning rate: 0.029
Training Time: 20.77 seconds
Mean Squared Error (MSE): 50.30377797365622
Mean Absolute Error (MAE): 5.32647921033457
Huber Loss: 4.854207515716553
R-squared: -0.0006062230488395683
SMAPE: 19.121918994715326


# LSTM Input: (192, 128, 128, 0.436)
| Series | Number 1 | Number 2 | Number 3 | Number 4 | Number 5 | Star 1 | Star 2 |
|---|---|---|---|---|---|---|---|
| Last Recorded | 7 | 10 | 31 | 41 | 46 | 1 | 5 |
| Prediction | 14 | -75 | 103 | -82 | 5 | 11 | 24 |
| Prediction Trend | Up | Down | Up | Down | Down | Up | Up |
| Actual Trend | Down | Down | Down | Down | Down | Up | Up |
| Actual Series | 2 | 3 | 17 | 40 | 44 | 4 | 8 |
First layer: 192
Second_layer: 128
...
Mean Squared Error (MSE): 4254.838950548453
Mean Absolute Error (MAE): 50.11077941680441
Huber Loss: 49.61403274536133
R-squared: -56.46756974628905
SMAPE: 67.86892924962747
...
```
